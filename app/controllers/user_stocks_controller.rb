class UserStocksController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @user_stock.save
        format.html { redirect_to my_portfolio_url, notice: "Stock #{@user_stock.stock.ticker} was successfully added." }
  ...
  def destroy
    @user_stock.destroy
    respond_to do |format|
      format.html { redirect_to my_portfolio_url, notice: 'Stock was successfully removed form portfolio.' }
